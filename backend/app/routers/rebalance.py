...
class RebalanceRequest(BaseModel):
    ...
    current_allocations: list[dict]  # [{"asset_class": "...", "current_pct": 30}, ...]
...
async def analyze_rebalancing(
    ...
    return compute_rebalancing(request.current_allocations, portfolio.allocations, request.portfolio_value)
