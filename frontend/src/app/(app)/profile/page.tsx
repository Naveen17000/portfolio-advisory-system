...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <>
        <div className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8" role="main" aria-label="Loading profile">
  ...
  return (
    <>
        <div className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8" role="main" aria-label="Financial profile">
