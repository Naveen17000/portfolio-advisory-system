...
export default function SpendingPage() {
  ...
  if (loading) {
    return (
      <>
        <div className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8" role="main" aria-label="Loading spending tracker">
  ...
  return (
    <>
        <div className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8" role="main" aria-label="Spending tracker">
