...
export default function ExplainPage() {
  ...
  if (loading) {
    return (
      <>
        <div className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8" role="main" aria-label="Loading risk explainability">
  ...
  return (
    <>
        <div className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8" role="main" aria-label="Risk score explainability">
